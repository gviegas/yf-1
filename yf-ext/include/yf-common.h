...
/* Version definitions. */
#define YF_EXT_MAJOR 0
#define YF_EXT_MINOR 1
#define YF_EXT_PATCH 1
#define YF_EXT_VERSION YF_VERSION_MAKE(YF_CORE_MAJOR, YF_CORE_MINOR)
#define YF_EXT_VERSION_0_1 YF_VERSION_MAKE(0, 1)

/* XXX: These are also provided by yf-core. */
